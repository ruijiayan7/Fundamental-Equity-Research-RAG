...
export default function Recorder(props: {
  ...
  return recording ? (
    ...
    <Button shape="circle" variant="filled" color="default" onClick={startASR} style={{ backgroundColor: '#E8784A', border: 'none' }}>
      <img src={IconRecorder} style={{ filter: 'brightness(0) invert(1)' }} />
    </Button>
  )
}
